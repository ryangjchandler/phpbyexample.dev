[PHP](https://php.net) is a general purpose programming language primarily used for web development. It powers a large majority of the websites on the internet today.
